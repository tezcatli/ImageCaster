...
class TextureRenderer(val viewportWidth: Int, val viewportHeight: Int) {
    ...
    fun loadImage(bitmap: Bitmap, mvpMatrix: FloatArray) {
    ...
    fun draw() {
        ...
        //Log.e("GL20",  "Starting drawing on surface from thread ${Thread.currentThread()}")
        ...
        //Log.e("GL20",  "Ending drawing on surface from thread ${Thread.currentThread()}")
